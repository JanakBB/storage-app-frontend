  ...
  return (
    <div className="w-full max-w-md mx-auto p-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6">
        ...
        {/* Perfect Centered Google + GitHub Buttons */}
        <div className="space-y-4 max-w-sm mx-auto">
          {/* Google Login — Full Width, Centered */}
          <div className="flex justify-center w-full">
            <div className="w-full max-w-[350px]">
              <GoogleLogin
                ...
                theme="outline"
                size="large"
                width="350" // Use fixed pixel value instead of percentage
                shape="pill"
              />
            </div>
          </div>

          {/* GitHub Login — Perfect Match */}
          <div className="flex justify-center w-full">
            <button
              onClick={loginWithGitHub}
              className="w-full max-w-[350px] flex items-center justify-center cursor-pointer gap-3 px-6 py-[10.5px] bg-[#24292f] hover:bg-[#1d2127] text-white font-medium text-[15px] rounded-full border border-gray-800 transition-all duration-200 shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
            >
