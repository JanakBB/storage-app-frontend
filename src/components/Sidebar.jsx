...
const Sidebar = () => {
  ...
  // REAL navigation items that work with your existing routes
  const menuItems = [
    {
      icon: Home,
      label: "My Drive",
    ...
    // These would need backend support - showing as disabled for now
    ...
    <div className="w-64 bg-white border-r border-gray-200 min-h-screen flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-xl font-semibold text-gray-900">Storage Drive</h1>
        </div>

        <button
          className="w-full bg-blue-600 text-white py-2.5 px-4 rounded-lg flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors mb-4"
          onClick={() => navigate("/")}
        >
          <Upload size={18} />
          New Upload
      ...
      {/* Navigation - NOW PROPERLY INTERACTIVE */}
